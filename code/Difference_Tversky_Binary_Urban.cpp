...
int blue_weight = 1, red_weight = -4;
...
int main() {
  int eps = 1000;
  vector<Point_1D> *db = read_urbangb("../dataset/UrbanDB.csv");
  double salary_start = -0.130983, salary_end = 0.228074;
  std::cout << "Epsilon value set to : " << eps << std::endl;
  std::cout << "Initial range value set to : " << salary_start << ":"
            << salary_end << std::endl;
  ...
  // Assuming you want to run this against the 'out_fast' range:
