    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (resTree == null) {
                ...
                System.out.println("Tree Best range = [" + resTree.leftVal + "," + resTree.rightVal + "] (similarity = " + resTree.similarity + ")");
            }
            ...
            if (resBF == null) {
                ...
                System.out.println("BruteForce Best range = [" + resBF.leftVal + "," + resBF.rightVal + "] (similarity = " + resBF.similarity + ")");
            }
    ...
    static Data readCSV(String filename, int expectedColors) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filename))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                // Clean the array to prevent trailing spaces from creating empty strings
                ...
                try {
                    double key = Double.parseDouble(parts.get(0));
                    int color = Integer.parseInt(parts.get(parts.size() - 1));
                    
                    // STRICT ENFORCEMENT: Only process colors between 1 and the expected argument
        ...
        if (rawRows.isEmpty()) {
            return new Data(0, new double[0], 0, new ArrayList<>(), new LinkedHashSet<>(), new int[0][0], new double[0][0]);
        }
        ...
        for (int c : colors) {
            uniqueColorsStr.add(String.valueOf(c));
        }
